...
import type { ModelsClientViewProps } from "@/components/organisms/ModelsClient/modelsClientTypes";
import type { ProfilesClientViewProps } from "@/components/organisms/ProfilesClient/profilesClientTypes";

vi.mock("@/components/organisms/ModelsClient/modelsClientView", () => ({
...
vi.mock("@/components/organisms/ProfilesClient/profilesClientView", () => ({
  ProfilesClientView: ({
    editingProfile,
    onAssignmentChange,
    onCreate,
