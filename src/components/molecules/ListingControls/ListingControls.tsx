...
import type { ListingControlsProps } from "./ListingControls.types";
        ...
        <div key={f.key} className="space-y-1">
          ...
          >
            <Select.Trigger
              ...
              className={cn("flex h-9 items-center justify-between gap-1 rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm transition-colors", "focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring")}
            >
